...
$.testBrowser = function(options) {
	var opts = $.extend(true,{
		reject : { // Rejection flags for specific browsers
			...
			opera: true, trident: true, khtml: true, presto: true, msie: true, firefox: true, unknown: true
			/*
		...
		display: ['chrome', 'safari', 'gcf'], // What browsers to display and their order (default set below)
	...
	element.find('#jr_inner').css({
		minWidth: displayNum*280,
		maxWidth: displayNum*280,
