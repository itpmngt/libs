...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.results_show = function() {
      ...
      if(this.options.dropdown_direction == 'up'){
        var availableOptions = $(".active-result").length;
        if(availableOptions>9){dd_top = (dd_top * -7) - (dd_top/2) - dd_top - 4}
        else{dd_top = ( ( (dd_top - 4) * -1 * (availableOptions -3) ) - (dd_top*2) - dd_top - 4 ) } } // dropdown scroll up
